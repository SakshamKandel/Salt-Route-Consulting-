    ...
    <div className="min-h-screen bg-background flex flex-col pt-24">
      <main className="flex-1 max-w-4xl w-full mx-auto px-6 py-24">
        <div className="text-center mb-16">
          ...
          <p className="text-charcoal/40 text-sm font-sans tracking-wide">Last updated: April 2026</p>
        </div>
        ...
        <article className="bg-white border border-charcoal/5 p-10 md:p-16">
          <div className="space-y-12 text-charcoal/60 text-base leading-relaxed font-light">
            <Section title="1. Acceptance of Terms">
              By accessing or using the {siteConfig.name} platform, you agree to be bound by these Terms of Service. If you do not agree, please do not use our services.
            </Section>
            ...
            <Section title="5. User Accounts">
              You are responsible for maintaining the confidentiality of your account credentials. You agree to notify us immediately of any unauthorized use of your account. {siteConfig.name} is not liable for any loss resulting from unauthorized use of your account.
            </Section>
            ...
            <Section title="7. Intellectual Property">
              All content on the {siteConfig.name} platform, including text, images, logos, and design, is the property of {siteConfig.name} or its licensors and is protected by applicable intellectual property laws.
            </Section>
            <Section title="8. Limitation of Liability">
              {siteConfig.name} is not liable for any indirect, incidental, or consequential damages arising from your use of the platform or our services. Our total liability to you shall not exceed the amount paid for the relevant booking.
            </Section>
