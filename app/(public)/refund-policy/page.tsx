      ...
      <main className="flex-1 max-w-4xl w-full mx-auto px-6 py-24">
        ...
        <article className="bg-white border border-charcoal/5 p-10 md:p-16">
          <div className="space-y-12 text-charcoal/60 text-base leading-relaxed font-light">
            ...
            <Section title="Cancellation 7 to 29 Days Before Check-In">
            ...
            <Section title="Property-Initiated Cancellations">
              In the rare event that a property cancellation is initiated by {siteConfig.name} or the property owner, you will receive a full refund within 5 to 10 business days, plus our best effort to arrange an equivalent alternative property.
            </Section>
            ...
            <Section title="Refund Processing">
              Approved refunds are processed to the original payment method within 5 to 10 business days. Processing times may vary depending on your bank or card issuer.
            </Section>
