  ...
  return <footer className={styles.footer}>
    <div className={styles.footerInner}>
      <div className={styles.footerMain}>
        <div className={styles.footerBrand}><Link href="/" aria-label="Salt Route home"><Image src="/brand/logo.png" alt={siteConfig.brandName} width={1947} height={808} /></Link><p>Distinctive stays.<br />A personal connection to Nepal.</p></div>
